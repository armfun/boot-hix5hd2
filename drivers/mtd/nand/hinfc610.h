...
#  warning NOT config CONFIG_HINFC610_REG_BASE_ADDRESS, used default value, maybe invalid.
...
#  warning NOT config CONFIG_HINFC610_BUFFER_BASE_ADDRESS, used default value, maybe invalid.
